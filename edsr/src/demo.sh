...
python main.py --model EDSR --epochs 10 --batch_size 16 --loss 1*pereptual-0-17 --scale 2 --save edsr_x2_new --n_resblocks 32 --n_feats 256 --res_scale 0.1 --print_every 1 --reset
