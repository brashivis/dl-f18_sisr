...
#python main.py --model EDSR --epochs 10 --batch_size 16 --loss 1*perceptual-17 --scale 2 --save edsr_x2_perceptual_loss --n_resblocks 32 --n_feats 256 --res_scale 0.1 --print_every 1 --reset
...
python main.py --data_test Demo --scale 2 --batch_size 16 --n_resblocks 32 --n_feats 256 --res_scale 0.1 --pre_train ./trained/edsr_x2_perceptual_loss/model/model_latest.pt --test_only --save_results
